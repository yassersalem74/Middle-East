...
export default function HeroSection() {
  ...
  return (
    <section
      className="relative min-h-[70vh] md:min-h-[85vh] flex items-center justify-center rounded-b-[40px] overflow-hidden bg-cover bg-center *:overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl px-6 md:px-12 text-center mx-auto">
        ...
        >
          ...
          <img src="hero-icon.png" alt="arrow icon" className="w-6 h-6" />
        </button>
      </div>
    </section>
  );
